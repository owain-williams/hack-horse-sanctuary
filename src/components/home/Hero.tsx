    ...
    <section className="relative h-[90vh] min-h-150 w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          <source
            src="https://www.pexels.com/download/video/3192024/"
            type="video/mp4"
          />
      ...
      <div className="relative z-20 container mx-auto flex h-full flex-col justify-center px-4 text-white">
        ...
        >
          ...
          >
            We rescue, rehabilitate, and rehome abused and neglected horses
            across the UK. Join us in giving them a second chance at life.
          </motion.p>
